...
function wp_cumulus_install () {
	...
	$newoptions['tcolor'] = 'F5F5F5';
	$newoptions['tcolor2'] = 'F5F5F5';
	$newoptions['hicolor'] = 'F5F5F5';
...
function wp_cumulus_createflashcode( $widget=false, $atts=NULL ){
	...
	if( $options['compmode']!='true' ){
		...
		$flashtag .= '</p><p>WP Cumulus Flash tag cloud by <a href="http://blog.ithomer.net" rel="nofollow">IT-Homer</a> requires <a href="http://www.macromedia.com/go/getflashplayer">Flash Player</a> 9 or better.</p></div>';
        ...
        $flashtag .= '<param name="bgcolor" value="#F5F5F5" />';
		...
		$flashtag .= '<p>WP-Cumulus by <a href="http://blog.ithomer.net" rel="nofollow">IT-Homer</a> requires <a href="http://www.macromedia.com/go/getflashplayer">Flash Player</a> 9 or better.</p>';
		$flashtag .= '</object>';
	}
	return $flashtag;
}
