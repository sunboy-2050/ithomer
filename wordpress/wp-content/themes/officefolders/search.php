...
<div class="entry">
 ...
 <div class="commentsdata"><img style="vertical-align:-5px;" alt="comments" src="<?php bloginfo('template_directory'); ?>/images/comment.gif" height="16" width="16" /> <?php comments_popup_link(__('Comments (0)'), __('Comments (1)'), __('Comments (%)')); ?> </div>

<!--
 <div class="authordata">By <?php the_author_posts_link(); ?>, <?php the_time($dateFormat); ?></div>
--> 
...
<!--	
		<div class="postmetadata">
			...
			<p><img style="vertical-align:-5px;" alt="categories" src="<?php bloginfo('template_directory'); ?>/images/category.gif" height="16" width="16" /> <?php the_category(', ') ?> 
			 <?php if (get_the_tags()){?>
		 		  	| <img style="vertical-align:-5px;" alt="categories" src="<?php bloginfo('template_directory'); ?>/images/tag.gif" height="16" width="16" /> <?php the_tags('') ?>
		<?php } ?>
